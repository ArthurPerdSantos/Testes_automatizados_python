...
def test_deve_permitir_propor_lance_quando_o_valor_e_maior_que_o_valor_da_carteira(vini, leilao):
    with pytest.raises(Lance_invalido):
        vini.propoe_lance(leilao, 120.0)
